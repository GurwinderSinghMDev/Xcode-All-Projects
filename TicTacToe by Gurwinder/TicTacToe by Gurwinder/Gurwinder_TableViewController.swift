//
//  Gurwinder_TableViewController.swift
...
class Gurwinder_TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Gurwinder_TableCell", for: indexPath) as! Gurwinder_TableViewCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let whichCell = sender as! Gurwinder_TableViewCell
        
        let desnationView = segue.destination as! Gurwinder_GameViewController
        desnationView.replayingPastGame = true
        desnationView.pastGameData = whichCell.gameData
    }
